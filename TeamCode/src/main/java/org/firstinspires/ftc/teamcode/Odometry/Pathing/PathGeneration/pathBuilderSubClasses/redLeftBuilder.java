...
public class redLeftBuilder extends pathBuilderMain {
    ...
    //first pos DONE!!!!
    Vector2D DPS1F = new Vector2D(getRealCoords(90), getRealCoords(337));
    Vector2D DPC1F = new Vector2D(getRealCoords(43), getRealCoords(319));
    Vector2D DPC21F = new Vector2D(getRealCoords(55), getRealCoords(258));
    Vector2D DPE1F = new Vector2D(getRealCoords(75), getRealCoords(297));

    //drop yellow pixel first
    Vector2D DYS1F = new Vector2D(DPE1F.getX(), DPE1F.getY());
    Vector2D DYC1F = new Vector2D(getRealCoords(101), getRealCoords(325));
    Vector2D DYE1F = new Vector2D(getRealCoords(89), getRealCoords(233));

    Vector2D DYS2F = new Vector2D(DYE1F.getX(), DYE1F.getY());
    Vector2D DYC2F = new Vector2D(getRealCoords(91), getRealCoords(191));
    Vector2D DYE2F = new Vector2D(getRealCoords(157), getRealCoords(193));

    Vector2D DYS3F = new Vector2D(DYE2F.getX(), DYE2F.getY());
    Vector2D DYC3F = new Vector2D(getRealCoords(295), getRealCoords(187));
    Vector2D DYE3F = new Vector2D(getRealCoords(300), getRealCoords(255));
    ...
    //second pos
    Vector2D DPS1S = new Vector2D(getRealCoords(90), getRealCoords(337));
    ...
    //third pos DONE!!!!!
    Vector2D DPS1T = new Vector2D(getRealCoords(90), getRealCoords(337));
