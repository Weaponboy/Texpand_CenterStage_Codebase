...
public class Blue_Far_Truss extends LinearOpMode implements CycleMethods {
    ...
    Vector2D DPC1F = new Vector2D(getRealCoords(86), getRealCoords(150));
    Vector2D DPCT1F = new Vector2D(getRealCoords(58), getRealCoords(83));
    Vector2D DPE1F = new Vector2D(getRealCoords(39), getRealCoords(89));

    //yellow pixel
    Vector2D DYS1F = DPE1F;
    Vector2D DYC1F = new Vector2D(getRealCoords(40), getRealCoords(68));
    Vector2D DYE1F = new Vector2D(getRealCoords(90), getRealCoords(36));

    Vector2D DYS2F = DYE1F;
    Vector2D DYE2F = new Vector2D(getRealCoords(210), getRealCoords(35));

    Vector2D DYS3F = DYE2F;
    Vector2D DYC3F = new Vector2D(getRealCoords(255), getRealCoords(36));
    Vector2D DYE3F = new Vector2D(getRealCoords(313), getRealCoords(79));
    ...
    Vector2D DE1F = new Vector2D(getRealCoords(119), getRealCoords(39));

    Vector2D DS2F = DE1F;
    Vector2D DE2F = new Vector2D(getRealCoords(181), getRealCoords(36));

    //segment 3
    Vector2D DS3F = DE2F;
    Vector2D DC3F = new Vector2D(getRealCoords(220), getRealCoords(50));
    ...
    Vector2D CC1F = new Vector2D(getRealCoords(265), getRealCoords(38));
    Vector2D CE1F = new Vector2D(getRealCoords(180), getRealCoords(36));

    Vector2D CS2F = CE1F;
    Vector2D CE2F = new Vector2D(getRealCoords(119), getRealCoords(35));

    Vector2D CS3F = CE2F;
    Vector2D CC3F = new Vector2D(getRealCoords(25), getRealCoords(75));
    Vector2D CE3F = new Vector2D(getRealCoords(38), getRealCoords(98));

    /**Middle Prop position*/
    //purple pixel
    Vector2D DPS1S = startPosition;
    Vector2D DPC1S = new Vector2D(getRealCoords(104), getRealCoords(118));
    Vector2D DPCT1S = new Vector2D(getRealCoords(66), getRealCoords(74));
    Vector2D DPE1S = new Vector2D(getRealCoords(39), getRealCoords(91));
    ...
    Vector2D DYE3S = new Vector2D(getRealCoords(312), getRealCoords(94));

    /**delivery and collection points*/
    Vector2D DS1S = new Vector2D(getRealCoords(44), getRealCoords(90));
    Vector2D DC1S = new Vector2D(getRealCoords(53), getRealCoords(31));
    Vector2D DE1S = new Vector2D(getRealCoords(119), getRealCoords(34));
    ...
    Vector2D CS3S = CE2S;
    Vector2D CC3S = new Vector2D(getRealCoords(25), getRealCoords(75));
    Vector2D CE3S = new Vector2D(getRealCoords(37), getRealCoords(95));

    /**Right Prop position*/
    //purple pixel
    Vector2D DPS1T = startPosition;
    Vector2D DPE1T = new Vector2D(getRealCoords(76), getRealCoords(95));

    Vector2D DPS2T = DPE1T;
    Vector2D DPC2T = new Vector2D(getRealCoords(70), getRealCoords(60));
    Vector2D DPE2T = new Vector2D(getRealCoords(40), getRealCoords(93));

    //yellow pixel
    Vector2D DYS1T = DPE1T;
    Vector2D DYC1T = new Vector2D(getRealCoords(40), getRealCoords(68));
    Vector2D DYE1T = new Vector2D(getRealCoords(90), getRealCoords(37));

    Vector2D DYS2T = DYE1T;
    Vector2D DYE2T = new Vector2D(getRealCoords(210), getRealCoords(36));

    Vector2D DYS3T = DYE2T;
    Vector2D DYC3T = new Vector2D(getRealCoords(261), getRealCoords(36));
    Vector2D DYE3T = new Vector2D(getRealCoords(312), getRealCoords(120));

    /**delivery and collection points*/

    Vector2D DS1T = new Vector2D(getRealCoords(44), getRealCoords(90));
    Vector2D DC1T = new Vector2D(getRealCoords(53), getRealCoords(34));
    ...
    //segment 3
    Vector2D DS3T = DE2T;
    Vector2D DC3T = new Vector2D(getRealCoords(220), getRealCoords(50));
    Vector2D DE3T = new Vector2D(getRealCoords(320), getRealCoords(65));
    ...
    Vector2D CS3T = CE2T;
    Vector2D CC3T = new Vector2D(getRealCoords(25), getRealCoords(75));
    Vector2D CE3T = new Vector2D(getRealCoords(37), getRealCoords(95));
    ...
    Vector2D restartIntake = new Vector2D(getRealCoords(75), getRealCoords(60));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeInInit()){
            ...
            if (buildPaths.seconds() > 2 && propPos == 1){
                ...
                yellow.threePoints(DYS3F, DYC3F, DYE3F, true, 1.1);
                        ...
                        switch (preload){
                            case purple:
                                ...
                                if (pathing){
                                    ...
                                    if (Math.abs(oneEightyHeadingT.getX() - odometry.X) < HeadingControlError && Math.abs(oneEightyHeadingT.getY() - odometry.Y) < 30 && targetHeading == 305){
                                        targetHeading = 180;
                                    }
