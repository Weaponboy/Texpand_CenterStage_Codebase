...
import org.firstinspires.ftc.teamcode.hardware.DeliveryOneDriver;
import org.firstinspires.ftc.teamcode.hardware.Delivery_Slides;
import org.firstinspires.ftc.teamcode.hardware.Delivery_SlidesOneDriver;
...
@TeleOp
public class BlueTeleopOneDriver extends OpMode implements TeleopPathing {
    ...
    Delivery_SlidesOneDriver deliverySlides = new Delivery_SlidesOneDriver();
...
//
//            if (slow){
//                vertical = Range.clip(vertical, -0.5, 0.5);
//                horizontal = Range.clip(horizontal, -0.5, 0.5);
//            }
...
//        }
        ...
        if ((gamepad1.dpad_up || (gamepad1.right_stick_button && deliverySlides.getCurrentposition() > 200)) && deliverySlides.getCurrentposition() > 200){
            delivery.setArmTargetState(Delivery.armState.delivery);
        } else if (gamepad1.dpad_down && deliverySlides.getCurrentposition() > 200) {
...
//        }
        ...
        if (gamepad1.right_stick_button && deliverySlides.getCurrentposition() < 50) {
        ...
        switch (delivery.getLeftgripperstate()){
            ...
            case closed:
                ...
                if (currentGamepad1.right_bumper && !currentGamepad1.right_bumper && Objects.requireNonNull(delivery.getArmState()) == Delivery.armState.collect) {
                    delivery.setLeftGripperState(Delivery.leftGripperState.open);
                } else if (currentGamepad1.right_bumper && !currentGamepad1.right_bumper && Objects.requireNonNull(delivery.getArmState()) == Delivery.armState.delivery) {
            ...
            case open:
                ...
                if (currentGamepad1.right_bumper && !currentGamepad1.right_bumper) {
        ...
        switch (delivery.getRightgripperstate()){
            ...
            case closed:
                ...
                if (currentGamepad1.left_bumper && !previousGamepad1.left_bumper && Objects.requireNonNull(delivery.getArmState()) == Delivery.armState.collect) {
                    delivery.setRightGripperState(Delivery.rightGripperState.open);
                } else if (currentGamepad1.left_bumper && !currentGamepad1.left_bumper && Objects.requireNonNull(delivery.getArmState()) == Delivery.armState.delivery) {
...
//        }
        ...
        if (((Math.abs(drive.LB.getPower()) > 0.5) || gamepad1.dpad_down) && deliverySlides.getCurrentposition() > 200){

            delivery.setArmTargetState(Delivery.armState.collect);

            deliverySlides.DeliverySlides(deliverySlides.getCurrentposition() + 50, 0.8);

            deliverySlides.setSlideState(Delivery_SlidesOneDriver.SlideState.moving);
...
//        }
        ...
        if (resettingSlides){
            ...
            if (deliverySlides.getCurrentDraw() >= 2600){
...
//        }
        ...
        delivery.updateArm(deliverySlides.getCurrentposition(), odometry, gamepad1);
        delivery.updateGrippers();
        ...
        telemetry.addData("intake current draw", deliverySlides.getCurrentDraw());
        ...
        telemetry.addData("second pivot position", delivery.getSecondPivotPosition());
