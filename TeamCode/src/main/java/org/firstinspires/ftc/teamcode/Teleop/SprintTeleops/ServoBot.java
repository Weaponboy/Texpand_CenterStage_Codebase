...
//            LeftDrive.setPosition(0);
//        }else {
//            RightDrive.setPosition(0.5);
//            LeftDrive.setPosition(0.5);
//        }

        double denominator = Math.max(Math.abs(vertical) + Math.abs(pivot), 2);

        double rightPower = (((vertical - pivot)/denominator));
        double leftPower = (((vertical - pivot)/denominator));
